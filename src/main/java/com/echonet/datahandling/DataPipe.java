...
public class DataPipe {
    ...
    /**
     * Can read any amount of data that is associated with the domain's primary key
     * @param d - any subclass of domain 
     * @return a List of Maps, same maps generated by {@code DataPipe.read()}, null if error occurs
     * @see DataPipe.read
     */
    ...
    /**
     * Overload of multiRead, has the same functionality as {@code DataPipe.read()}, but instead client can specify which column and value to read
     * @param d - any subclass of {@code Domain}
     * @param tableColumnName - the column name that {@code DataReader} should search
     * @param value - the value that {@code DataReader} should look for
     * @return - List of Maps, same maps generated by {@code DataPipe.read()}, null if error occurs
     * @see DataPipe.multiRead
     */
